...
# Use one stable framework EGLDisplay for legacy vendor EGL implementations.
SOONG_CONFIG_NAMESPACES += EGL
SOONG_CONFIG_EGL += USE_DISPLAY_ARRAY
SOONG_CONFIG_EGL_USE_DISPLAY_ARRAY := true
